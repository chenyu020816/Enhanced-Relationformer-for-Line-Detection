...
from models.dataset_road_network import build_road_network_data
...
from models.utils import image_graph_collate_road_network
...
def main(args):
    ...
    with torch.no_grad():
        ...
        for batchdata in test_loader: 
            ...
            pred_nodes, pred_edges, _, pred_nodes_box, pred_nodes_box_score, pred_nodes_box_class, pred_edges_box_score, pred_edges_box_class = relation_infer(
